...
namespace TPS168.DAL
{
    public class OrderDB
    {
        ...
        public DataSet OrderQueryNew(String _orderState, String _queryString, String _pageIndex, String _pageSize, out int _pageAmount)
        {
            _dbHelper.Open();
            _pageAmount = _dbHelper.ExecuteSPNonQuery("dbo.OrderQueryNew", _orderState, _queryString, _pageIndex, _pageSize, null);
            DataSet _ds = _dbHelper.ExecuteSPDataSet("dbo.OrderQueryNew", _orderState, _queryString, _pageIndex, _pageSize, null);
            _dbHelper.Close();
            return _ds;
        }
        ...
        public DataSet OrderPriceAmount(String _orderState)
        {
            _dbHelper.Open();
            DataSet _ds = _dbHelper.ExecuteSPDataSet("dbo.OrderPriceAmount", _orderState);
            _dbHelper.Close();
            return _ds;
        }
